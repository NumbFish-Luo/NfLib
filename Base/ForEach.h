...
// DEF /////////////////////////////////////////////////////////////////////////
#define _ForEach_DEF(ITER, FUNC)                                                \
void ForEach(ITER, FUNC) (ITER begin, ITER end, void (*IterNext) (ITER* iter), FUNC Func)
#define ForEach_DEF(ITER, FUNC) _ForEach_DEF(ITER, FUNC)

// IMPL ////////////////////////////////////////////////////////////////////////
#define _ForEach_IMPL(ITER, FUNC) ForEach_DEF(ITER, FUNC) {                     \
    for (; begin != end; IterNext(&begin)) { Func(begin); }                     \
}
