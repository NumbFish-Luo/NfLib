...
#define CallNode_IMPL(NODE)      void Call_##NODE(FsmNode* this, const char* args)
...
#define CallLine_IMPL(LINE)                            void Call_##LINE(FsmLine* this, const char* args)
#endif
...
typedef void (*FsmNodeCall) (FsmNode* this, const char* args);
typedef void (*FsmLineCall) (FsmLine* this, const char* args);
